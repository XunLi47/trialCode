...
public class DictCodeConstants {
	 ...
	 * 三日电访时间
	 */
	public static final String DICT_TRACING_TYPE = "1125"; // 三日电访时间类别
	public static final String DICT_TRACING_TIME_NOON = "11251001"; // 中午
	public static final String DICT_TRACING_TIME_AFTERNOON = "11251002"; // 下午
	public static final String DICT_TRACING_TIME_MORN = "11251003"; // 早上
	public static final String DICT_TRACING_TIME_ALL_DAY = "11251004"; // 全天
	/**
	 * 跟进方式
	 */
	...
	// 优惠模式
	public static final int DISCOUNT_MODE_OPTION = 5;
	// 系统提醒
	...
	public static final int FILE_TYPE_PART_INFO_INSPECTION = 10421006;
    public static final int     FILE_TYPE_CODE_INSPECTION = 10421007;
    public static final int     FILE_TYPE_CODE_BIG_CUSTOMER = 10421008;//大客户申请
    public static final int     FILE_TYPE_CODE_TEST_DRIVE1 = 10421009;//试乘试驾驾驶证
    public static final int     FILE_TYPE_CODE_TEST_DRIVE2 = 10421010;//试乘试驾身份证
    public static final int     FILE_TYPE_CODE_TEST_DRIVE3 = 10421011;//试乘试驾协议照片
    public static final int     FILE_TYPE_CODE_TEST_DRIVE4 = 10421012;//试乘试驾反馈照片
	/**
	 * 派工状态
	 */
	// 已派工
	public static final int ASSIGN_ORDER_ALL = 12901003;
	// 部分派工
	public static final int ASSIGN_ORDER_SOME = 12901002;
	// 未派工
	public static final int ASSIGN_ORDER_NO = 12901001;
	// 竣工
	...
	public static final int DICT_CUS_SOURCE_BY_WEBS = 13111020; // 保客置换
     ...
     *
     */
    public static final String  DICT_DELIVERY_STATUS = "5008"; // 货运单状态
    public static final String  DICT_DELIVERY_STATUS_NO = "50081005"; // 未签收
    public static final String  DICT_DELIVERY_STATUS_PART = "50081006"; // 部分签收
    public static final String  DICT_DELIVERY_STATUS_ALL = "50081003"; // 全部签收
     ...
     * 工单拆分状态
     */
        public static final String  DICT_RO_SPLIT_STATUS_TYPE = "1360"; //工单拆分状态类型
        public static final String  DICT_RO_SPLIT_STATUS_NOT_SPLIT = "13601001"; //未拆
        public static final String  DICT_RO_SPLIT_STATUS_SPLITED = "13601002"; //已拆
        public static final String  DICT_RO_SPLIT_STATUS_BY_SPLITED = "13601003"; //被拆
	...
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE = "1401"; // 会员积分业务类型
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_MANUAL_PRESENT = "14010001"; // 手工赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_REPAIR_PRESENT = "14010002"; // 维修赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_PRERECEIPT_PRESENT = "14010003"; // 预收款赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_STORE_PRESENT = "14010004"; // 储值赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_REPAIR_DEDUCT = "14010005"; // 维修使用
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_GIFTS_CHANGE = "14010006"; // 礼品兑换
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_CREDIT_CANCEL = "14010007"; // 积分取消
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_CREDIT_INITIAL = "14010008"; // 初始积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_CREDIT_ADJUST = "14010009"; // 积分调整
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_CREDIT_IN = "14010010"; // 转入
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_CREDIT_OUT = "14010011"; // 转出
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_INSURANCE = "14010012"; // 保险到期提醒成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_VEHICLE = "14010013"; // 验车到期提醒成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_NEW_VEHICLE = "14010014"; // 新车提醒成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_VEHICLE_LOSS = "14010015"; // 客户流失报警提醒成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_OWNER_BIRTHDAY = "14010016"; // 客户生日提醒提醒成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_REPAIR = "14010017"; // 保修到期提醒成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_TERMLY_MAINTAIN = "14010018"; // 定期保养提醒成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_TRACE_TASK = "14010019"; // 修后跟踪任务成功赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_MANUAL_CLEAR = "14010020"; // 手工清零
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_VEHICLE_PRESENT = "14010021"; // 整车销售赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_MANUAL_ADJUST = "14010022"; // 手工调整
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_INSURE_PRESENT = "14010023"; // 保险赠送
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_CANCEL_RETURN_CREDIT = "14010024"; // 反结算退还积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_MEMBER_BIRTHDAY = "14010025"; // 会员生日送积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_FIRST_KEEPBACK = "14010026"; // 首保回厂送积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_SECOND_CAR = "14010027"; // 二手车置换送积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_EXTEND_WARRANTY = "14010028"; // 延保销售送积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_OLD_MEMBER = "14010029"; // 老客户转介绍送积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_SERVICE_ORDER = "14010030"; // 装饰装潢送积分
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_EXTEND_USE = "14010031"; // 延保销售使用
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_SERVICE_USE = "14010032"; // 装饰装潢使用
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_PART_SALE = "14010033"; // 配件销售产生
	public static final String DICT_MEMBER_CREDIT_BUSINESS_TYPE_PART_SALE_USE = "14010034"; // 配件销售使用

	/**
	 * 会员储值业务类型
	 */
	public static final String DICT_MEMBER_STORE_TYPE = "1403"; // 会员储值业务类型
	public static final String DICT_MEMBER_STORE_TYPE_GOLD_TICKET_SUFFICIENT = "14030001"; // 代金卷充值
	public static final String DICT_MEMBER_STORE_TYPE_CASH_SUFFICIENT = "14030002"; // 现金充值
	public static final String DICT_MEMBER_STORE_TYPE_REPAIR_DEDUCT = "14030003"; // 维修使用
	public static final String DICT_MEMBER_STORE_TYPE_GIFTS_CHANGE = "14030004"; // 礼品兑换
	public static final String DICT_MEMBER_STORE_TYPE_STORE_IN = "14030005"; // 转入
	public static final String DICT_MEMBER_STORE_TYPE_STORE_OUT = "14030006"; // 转出
	public static final String DICT_MEMBER_STORE_TYPE_SALES_DEDUCT = "14030007"; // 销售使用
	public static final String DICT_MEMBER_STORE_TYPE_SERVICE_USE = "14030008"; // 装潢使用
	public static final String DICT_MEMBER_STORE_TYPE_CANCEL_BALANCE_RETURN = "14030009"; // 反结算退还储值
	public static final String DICT_MEMBER_STORE_TYPE_ACTIVITY_SPECIAL_FUND = "14030010"; // 会员活动专项资金
	public static final String DICT_MEMBER_STORE_TYPE_CANCEL_BALANCE_RETURN_FUND = "14030011"; // 反结算退还活动专项资金
	public static final String DICT_MEMBER_STORE_TYPE_EXTEND_USE = "14030012"; // 延保销售使用
	public static final String DICT_MEMBER_STORE_TYPE_SALES_PART_USE = "14030013"; // 配件销售使用

	/**
	 * 积分圆整方式
	 */
	public static final String DICT_CREDIT_ROUND_MODE_TYPE = "1398"; // 结算圆整方式类别
	public static final String DICT_CREDIT_ROUND_MODE_ROUND = "13981001"; // 四舍五入
	public static final String DICT_CREDIT_ROUND_MODE_TRUNCATE = "13981002"; // 只舍不入
	public static final String DICT_CREDIT_ROUND_MODE_NOT_TRUNCATE = "13981003"; // 只入不舍

	/**
	 * 职业类别
	 */
	public static final String DICT_VOCATION_TYPE = "1111"; // 职业类别类别
	public static final String DICT_VOCATION_LB = "11111001"; // 私营公司老板/自由职业者/个体户
	public static final String DICT_VOCATION_GLRY = "11111002"; // 中层管理人员
																// (如：部门经理等)
	public static final String DICT_VOCATION_XSRY = "11111003"; // 销售人员/销售代表
	public static final String DICT_VOCATION_SYGS = "11111004"; // 私营公司职员/主管
	public static final String DICT_VOCATION_JTZF = "11111005"; // 家庭主妇/夫
	public static final String DICT_VOCATION_TX = "11111006"; // 退休
	public static final String DICT_VOCATION_QT = "11111007"; // 其他
	public static final String DICT_VOCATION_DY = "11111008"; // 没有工作
	public static final String DICT_VOCATION_XS = "11111009"; // 学生
	public static final String DICT_VOCATION_TLLD = "11111010"; // 体力劳动者(技术工或熟练工)
	public static final String DICT_VOCATION_GWY = "11111011"; // 公务员，教师，警察，护士等
	public static final String DICT_VOCATION_XZZY = "11111012"; // 行政职员
	public static final String DICT_VOCATION_ZYRS = "11111013"; // 专业人士
																// (如：律师，医生等)
	public static final String DICT_VOCATION_GCRY = "11111014"; // 高层管理人员
																// (如：首席执行总裁，总监，总经理等)

	/**
	 * 菲亚特接货状态
	 */
	public static final String DICT_DMS_DELIVERY_STATUS = "1256"; // 菲亚特订货状态
	public static final String DICT_DMS_DELIVERY_STATUS_NO_BILLING = "12561001"; // 未接货
	public static final String DICT_DMS_DELIVERY_STATUS_PART_BILLING = "12561002"; // 部分确认
	public static final String DICT_DMS_DELIVERY_STATUS_COMPLETE_BILLING = "12561003"; // 完成

	/**
	 * 配件订单状态(BO)
	 */
	public static final String DICT_BO_PART_ORDER_TYPE = "1420"; // 配件订单状态(BO)
	public static final String DICT_BO_PART_ORDER_TYPE_AL_PURCHASE = "14201001"; // 已订购
	public static final String DICT_BO_PART_ORDER_TYPE_AL_SURE = "14201002"; // 已确认
	public static final String DICT_BO_PART_ORDER_TYPE_FLOAT = "14201003"; // 浮动
	public static final String DICT_BO_PART_ORDER_TYPE_PART_READY = "14201004"; // 部分完成
	public static final String DICT_BO_PART_ORDER_TYPE_READY = "14201005"; // 已完成
	public static final String DICT_BO_PART_ORDER_TYPE_CANCEL = "14201006"; // 已取消

	/**
	 * 续保战败原因
	 */
	public static final String DICDICT_RENEWAL_FAIL_REASON = "1393";
	public static final String DICT_RENEWAL_FAIL_REASON_HIGH_PRICE = "13931001"; // 价格高
	public static final String FDICT_RENEWAL_FAIL_REASON_BAD_SERVICE = "13931003"; // 出险服务差
	public static final String FDICT_RENEWAL_FAIL_REASON_BAD_SINGLE_SERVICE = "13931002"; // 出单服务差
	public static final String FDICT_RENEWAL_FAIL_REASON_BAD_REPAIR_SERVICE = "13931004"; // 维修质量差
	public static final String FDICT_RENEWAL_FAIL_REASON_OTHER = "13931005"; // 其他

	/**
	 * 配件缺料预约状态
	 */
	public static final String DICT_SPARE_PART_BOOKING_STATUS = "7011";
	public static final String DICT_SPARE_PART_BOOKING_STATUS_FLOATING = "70111001"; // 未到货
	public static final String DICT_SPARE_PART_BOOKING_STATUS_INVALID = "70111002"; // 作废
	public static final String DICT_SPARE_PART_BOOKING_STATUS_ALL = "70111003"; // 全部到货
	public static final String DICT_SPARE_PART_BOOKING_STATUS_PART = "70111004"; // 部分到货
	public static final String DICT_SPARE_PART_BOOKING_STATUS_BOOKING = "70111005"; // 预约
	public static final String DICT_SPARE_PART_BOOKING_STATUS_COMPLETED = "70111006"; // 已完成

	/**
	 * 缺料类型
	 */
	public static final String DICT_SHORT_TYPE = "1214"; // 缺料类型类别
	public static final String DICT_SHORT_TYPE_BOOKING = "12141001"; // 缺料类型对应TT_SHORT_PART表的SHORT_TYPE字段_预约缺料
	public static final String DICT_SHORT_TYPE_RO = "12141002"; // 工单缺料
	public static final String DICT_SHORT_TYPE_DISPENSE = "12141003"; // 发料缺料
	public static final String DICT_SHORT_TYPE_SALE = "12141004"; // 销售缺料
	public static final String DICT_SHORT_TYPE_OTHER = "12141005"; // 其它缺料

	/**
	 * 借用人类型
	 */
	public static final String DICT_BORROWER_TYPE = "1285"; // 借用人类型类别
	public static final String DICT_BORROWER_TYPE_CUSTOMER = "12851001"; // 客户
	public static final String DICT_BORROWER_TYPE_INTERIOR_EMPLOYEE = "12851002"; // 内部员工
	
	/**
	 * 入库类型
	 */
	public final static Integer STOCK_IN_TYPE = 7005;
	public final static Integer STOCK_IN_TYPE_01 = 70051001; // 货运单入库
	public final static Integer STOCK_IN_TYPE_02 = 70051002; // 临时入库
	public final static Integer STOCK_IN_TYPE_03 = 70051003; // 手工入库
	
	/**
	 * 加价类型
	 */
	public final static Integer PRICING_CLASSIFICATION = 1859;
	public final static Integer PRICING_CLASSIFICATION_01 = 18591001; // 加价分类一
	public final static Integer PRICING_CLASSIFICATION_02 = 18591002; // 加价分类二
	
	/**
	 * 配件尺寸
	 */
	public final static Integer PARTS_SIZE = 1860;
	public final static Integer PARTS_SIZE_01 = 18601001; // 配件尺寸一
	public final static Integer PARTS_SIZE_02 = 18601002; // 配件尺寸二
	
	/**
	 * 订单类型
	 */
	public final static Integer ORDER_TYPE = 8004;
	public final static Integer ORDER_TYPE_01 = 80041001; // 常规订单
	public final static Integer ORDER_TYPE_02 = 80041002; // 紧急订单
	public final static Integer ORDER_TYPE_03 = 80041003; // VOR订单
	public final static Integer ORDER_TYPE_04 = 80041004; // 受控订单
	public final static Integer ORDER_TYPE_05 = 80041005; // 直送订单
	
	/**
	 * 订单状态
	 */
	public final static Integer ORDER_STATUS = 8005;
	public final static Integer ORDER_STATUS_01 = 80051001; // 已保存
	public final static Integer ORDER_STATUS_02 = 80051002; // 已驳回
	public final static Integer ORDER_STATUS_03 = 80051003; // NIO待审核
	public final static Integer ORDER_STATUS_04 = 80051004; // NIO已通过
	public final static Integer ORDER_STATUS_05 = 80051005; // SAP通过
	public final static Integer ORDER_STATUS_06 = 80051006; // 已完成
	public final static Integer ORDER_STATUS_07 = 80051007; // 已取消
	public final static Integer ORDER_STATUS_08 = 80051008; // SAP驳回
	public final static Integer ORDER_STATUS_09 = 80051009; // SAP已处理
	
	public final static Integer FROM_ENTITY = 1004;
	public final static Integer FROM_ENTITY_01 = 10041001; // 车厂公司
	public final static Integer FROM_ENTITY_02 = 10041002; // 服务中心

	public final static Integer SIGN_STATE_01 = 80801001;//待签收
	public final static Integer SIGN_STATE_02 = 80801002; // 待评价
	public final static Integer SIGN_STATE_03 = 80801003; // 已评价
	
	/**
	 * 打款单提报状态
	 */
	public final static Integer SEND_STATUS = 1862;
	public final static Integer SEND_STATUS_01 = 18621001;//待提报
	public final static Integer SEND_STATUS_02 = 18621002;//已提报
	public final static Integer SEND_STATUS_03 = 18621003;//已转SAP
	
	/**
	 * 打款类型
	 */
	public final static Integer PRMITTANCE_TYPE = 1863;
	public final static Integer PRMITTANCE_TYPE_01 = 18631001;//汇款
	public final static Integer PRMITTANCE_TYPE_02 = 18631002;//承兑汇票
	
	/**
	 * 支付分类
	 */
	public final static Integer CHANNEL_TYPE = 4024;
	public final static Integer CHANNEL_TYPE_01 = 40241001;//线上支付
	public final static Integer CHANNEL_TYPE_02 = 40241002;//线下支付
